...
# Step 1: Open your ChatGPT Project and start a new chat inside it.
# Step 2: Paste everything inside the code block below into that chat.
...
Say: "Perfect. Here's what to do:

1. Click the ... menu next to your project name → Edit → paste the system prompt below into the Instructions field → Save
2. Once saved, start a NEW chat inside this project (the system prompt only activates for new chats)
3. In that new chat, paste this exactly to begin your onboarding:

> I've added my Project Instructions. Please fetch and run my onboarding prompts from this URL, then work through them with me one question at a time: https://raw.githubusercontent.com/1corey-f/ai-set-up/main/technical-team/onboarding-prompts.md"
...
Display the system prompt, then end this chat. The user will continue in a new chat inside the project.

If you can't display the system prompt, say: "Copy the system prompt from here instead: https://github.com/1corey-f/ai-set-up/blob/main/technical-team/system-prompt.md"
...
> I've added my Project Instructions. Please fetch and run my onboarding prompts from this URL, then work through them with me one question at a time: https://raw.githubusercontent.com/1corey-f/ai-set-up/main/advisor-coach/onboarding-prompts.md"
...
If you can't display the system prompt, say: "Copy the system prompt from here instead: https://github.com/1corey-f/ai-set-up/blob/main/advisor-coach/system-prompt.md"
...
1. Click the ... menu next to your project name → Edit → paste the system prompt below into the Instructions field → Save
2. Once saved, start a NEW chat inside this project (the system prompt only activates for new chats)
3. In that new chat, type: 'I've added my Project Instructions. I'm ready to start my onboarding interview — technical + coaching combined.'"
...
Display the system prompt. Then display the following as a clearly labelled copy-paste block and say: "Once you've added the system prompt and started a new chat inside the project, paste the block below to begin your onboarding interview:"

---PASTE THIS INTO YOUR NEW CHAT---

We're going to run a combined onboarding interview — it covers both your technical context and your personal development. It takes about 40–50 minutes. Work through it with me one question at a time.

Run the following combined interview, asking me one question at a time and waiting for my answer before moving on.
